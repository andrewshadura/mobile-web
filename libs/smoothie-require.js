...
// NOTE Since IE8 only allows to define getters on DOM-objects, we use an
//      HTMLElement object instead of a normal object.
// NOTE We need an HTMLAnchorElement to parse the module paths anyway, so we
//      define the cache to be anchor and use it also for that purpose.

var cache = document.createElement('A');
...
function resolve(identifier) {
    ...
    // NOTE The cache is a HTMLAnchorElement, so we can use is as a URL parser.
